<h2>ประวัติการขนส่งของ หมายเลข T0132413E</h2>
<br />
<hr />
...
<div class="row">
	<div class="container">
		...
		<div class="col-lg-4">
			<button type="submit" class="btn btn-default" style="margin:5px;">@Html.ActionLink("กลับไปยังหน้า ประวัติการขนส่ง", "History", "Admin_manage")</button>
		</div>
		<div class="col-lg-4"></div>
	</div>
</div>
